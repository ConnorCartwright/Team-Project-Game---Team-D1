...
public class Geometry {
    ...
    public static float diagonalDistance(Point p1, Point p2) {
        return diagonalDistance(p1.x,p1.y,p2.x,p2.y);
    }
    
    public static float diagonalDistance(float x1, float y1, float x2, float y2) {
