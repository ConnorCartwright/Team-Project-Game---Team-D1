...
/**
 * The <code>Secondary Weapon</code> class extends the generic Weapon class. It defines the data
 * that each Secondary Weapon below (e.g. Pistol, Revolver) must have in order to be a Secondary
 * Weapon. The Secondary Weapon will take up the clientPlayers second Weapon slot, which will be
 * accessed by pressing the '2' key on the keyboard. This will be the clientPlayers secondary weapon
 * and will be what they will use in tight situations.
 * 
 * @see Weapon
 * @author Team D1
...
public abstract class SecondaryWeapon extends Weapon {
	 ...
	 * @param reloadTime
	 *            the time it tkaes in ms for the gun to reload after the entire magazine is
	 *            expended.
	 * @param magSize
	 ...
	 *            weapon.
	 */
	public SecondaryWeapon(int weaponId, double accuracy, double damage, int cooldown, int range, int numProjectiles, double projectileSpeed,
