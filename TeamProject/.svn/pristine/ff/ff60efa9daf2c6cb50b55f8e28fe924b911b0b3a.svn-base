...
public abstract class ControlledCharacter extends AbstractCharacter {
	 ...
	 */
	protected ControlledCharacter(int id, int typeID, int team, double healthPoints, double stamina, double speed, int viewRange, int viewAngle,
			int radius, PrimaryWeapon primary, SecondaryWeapon secondary) {
	 ...
	 * 
	 * @param world
	 *            the world in which to fire the shot
	 */
	 ...
	 * 
	 * @param stamina
	 *            the level to set the characters stamina too
	 */
